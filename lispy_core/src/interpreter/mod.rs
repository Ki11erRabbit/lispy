...
impl Exception {
    ...
    #[no_mangle]
    pub extern "C" fn exception_new(who: *mut *mut c_char, symbol_len: usize, message: *mut c_char, string_len: usize, context: *mut Context) -> *mut Exception {
	let who = Value::new_symbol_from_c(who, symbol_len, context);
